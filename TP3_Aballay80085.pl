...
%ingresosMensualesporContrato(NumerodeContrato,FechadeIngreso(Dia,Mes,Año),MontoIngreso,MontoGastosdeDistribucion,Pais)
...
%contrato que “sólo” tenga como derecho de distribución:
%“cine”.
...
%Generar una regla que a partir del número de contrato
%determine el monto de la regalía para a abonar en un
%mes determinado.
...
%mensual, pasando por argumento el número de contrato
...
%
% 1- Si Neto Mensual > Monto Mínimo: debe abonar por el contrato el
% monto mínimo más el Monto de la regalía.
%
% 2- Si Neto Mensual <= Monto Mínimo: solo debe abonar el Monto Mínimo.
...
%determinados, genere una lista ordenada con el número
%de contrato cuyo monto total a pagar (monto mínimo +
%monto de la regalía) sea mayor al valor pasado como
...
%Regla6/2.
% Desarrollar una regla que informe el número de contrato, nombre del
% producto, nombre de la regalía, el nombre del tipo de producto, sólo de
% los contratos que tengan como mínimo 3 (tres) derechos de distribución
% y cuyo monto mínimo a pagar sea mayor a un valor pasado por argumento.
